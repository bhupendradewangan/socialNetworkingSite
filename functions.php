<?php
          ...
          global $link;
              ...
              if(mysqli_num_rows($result) == 0){
                  ...
                  while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "</a>
                            <a class='comments'  data-target='#comment' role='button'  data-userId='".$row["userid"]."' data-useremail='".$user["email"]."' data-tweetid='".$row["id"]."' data-tweet='".$row["tweet"]."' data-time='".time_since(time()-strtotime($row["datetime"]))."' >Comments</a>
                        </p></div>";
                  }
              }
        ...
        function displayTweetBox(){
            ...
            if(array_key_exists("id",$_SESSION)){
                ...
                <button id="postTweetButton" class="btn btn-dark mb-2">Post Tweets</button>
              </div>';
            }
        }
        ...
        function showProfile(){
              ...
              <div class="jumbotron" id="userinfo">
                    <h1 class="display-4">'.$row["name"].'</h1>

                    <p class="lead">'.$user["email"].'</p>
                    <p>
                    <button type="button" class="btn btn-secondary">Tweets <span class="badge badge-light">'.$tweetResult.'</span></button>
                    <button type="button" class="btn btn-secondary">Following <span class="badge badge-light">'.$countFollower.'</span></button>
                    <button type="button" class="btn btn-secondary">Follower <span class="badge badge-light">'.$countFollowing.'</span></button>
        ...
        function displayProfile(){
              ...
              /*  echo '<ul class="nav flex-column back bg-light" >
                  ...
                  echo '<div class="jumbotron bg-light back">
